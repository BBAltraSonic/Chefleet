...
- [x] 2.8 Add order status transitions via Edge function calls
- [x] 2.9 Implement pickup code verification flow
- [x] 2.10 Create order history and completed orders view
...
- [x] 3.1 Create pulsing FAB component for active orders
- [x] 3.2 Implement FAB state management (hidden, visible, pulsing)
- [x] 3.3 Add FAB tap handling to open active order modal
- [x] 3.4 Create FAB animations and visual feedback
- [x] 3.5 Integrate FAB with order BLoC state changes

### 2. Active Order Modal
- [x] 3.6 Create active order modal with order details and status
- [x] 3.7 Implement order status timeline visualization
- [x] 3.8 Add pickup code display with visibility rules
- [x] 3.9 Create vendor ETA and preparation time display
- [x] 3.10 Add contact vendor button linking to chat functionality
...
- [x] 4.1 Complete dish detail screen with quantity and pickup time selection
- [x] 4.2 Implement order checkout flow with payment integration
- [x] 4.3 Add order confirmation screen with pickup code generation
- [x] 4.4 Create order success state with tracking information
- [x] 4.5 Implement order modification and cancellation before acceptance
...
- [x] 4.11 Integrate payment status with order completion workflow
- [x] 4.12 Add payment verification before order finalization
- [x] 4.13 Create refund processing for cancelled orders
- [x] 4.14 Implement commission calculation and vendor payout processing
- [x] 4.15 Add financial transaction history for vendors
