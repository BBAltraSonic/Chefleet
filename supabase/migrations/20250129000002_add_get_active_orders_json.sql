-- ===========================================
-- GET ACTIVE ORDERS JSON RPC
-- Migration: 20250129000002_add_get_active_orders_json.sql
-- Description: Add RPC function to fetch full active order tree as JSON
-- ===========================================
...
COMMENT ON FUNCTION get_active_orders_json IS 'Fetches full active order details (including items and vendor) as JSON.';
