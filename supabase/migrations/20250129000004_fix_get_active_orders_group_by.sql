-- ===========================================
-- FIX GET ACTIVE ORDERS JSON RPC - GROUP BY
-- Migration: 20250129000004_fix_get_active_orders_group_by.sql
-- Description: Fix GROUP BY error in get_active_orders_json function
-- ===========================================
...
COMMENT ON FUNCTION get_active_orders_json IS 'Fetches full active order details (including items and vendor) as JSON. Fixed GROUP BY error.';
